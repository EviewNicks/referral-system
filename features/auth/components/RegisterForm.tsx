    ...
    <div className="min-h-screen bg-[#2C1F63] flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-3xl p-8 shadow-2xl z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-xl font-extrabold text-black tracking-tight">Buat Akun Baru</h1>
          <p className="text-xs text-gray-500 font-medium">Daftar untuk mulai menggunakan Kartjis.id</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-extrabold text-gray-700">Nama Lengkap</label>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[10px] text-gray-400 pl-1">Password minimal 8 karakter</p>
          </div>
        ...
        {/* Login Link */}
        <div className="text-center border-t border-gray-100 pt-4 flex flex-col gap-2">
          <p className="text-xs text-gray-500">
            Sudah punya akun?{" "}
            <Link href="/login" className="font-bold text-[#2C1F63] hover:underline">
              Masuk di sini
            </Link>
          </p>
          <Link href="/" className="text-xs font-bold text-gray-400 hover:text-[#2C1F63] transition-colors">
            ← Kembali ke Beranda Kartjis.id
          </Link>
        </div>
      </div>
    </div>
